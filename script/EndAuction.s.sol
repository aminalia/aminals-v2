...
contract EndAuction is Script {
    function run() external {
        ...
        for (uint256 i = 1; i <= 2; i++) {
            console.log("Aminal love by ID by user: ", aminals.getAminalLoveByIdByUser(i, 0x1f028f240A90414211425bFa38eB4917Cb32c39C));
            ...
            uint[8] memory winnerId = auction.visualIds[0];

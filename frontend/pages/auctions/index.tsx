...
import AuctionCardActive from '@/components/auction-card';
import AuctionCardInactive from '@/components/auction-card';
          ...
          <><div>
            ...
            { activeAuctions.length === 0 ? (
              ...
              activeAuctions.map((auction) => (
                <AuctionCardActive key={auction.auctionId} auction={auction} />
              ))
            )}
          </div>
            ...
            { inactiveAuctions.length === 0 ? (
             <p>No inactive auctions available.</p> 
              ...
              inactiveAuctions.map((auction) => (
                <AuctionCardInactive key={auction.auctionId} auction={auction} />
              ))
            )} 
          </div>
          </>

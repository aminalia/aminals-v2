...
abstract contract AminalsDescriptor is IAminal, NFTDescriptor {
     ...
     */
    function _aminalImage(uint _tokenId) internal view returns (string memory output) {
        ...
        output = string(abi.encodePacked(output, '<g id="shadow"><ellipse fill="#3c3d55" opacity="0.5"  cx="505" cy="971" rx="163" ry="12"/></g>'));
